...
<tr class="info"><th>Pr&eacut;nom</th><th>Nom</th><th>E-mail</th><th>Rue</th><th>Code postal</th><th>Localit&eacut;</th><th>Date inscription</th></tr>
<tr class="info"><td>${client.prenom }</td><td>${client.nom }</td><td>${client.email }</td><td>${client.rue }</td><td>${client.cp }</td><td>${client.localite }</td><td>${client.dateInscription }</td></tr>
</table>
</c:if>
